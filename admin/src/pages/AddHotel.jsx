...
function AddHotel() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!hotelData.name || !hotelData.location || !hotelData.price || !hotelData.description || !hotelData.image) {
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold text-gray-800 mb-4">Add New Hotel</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              placeholder="e.g., Grand Horizons Hotel"
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              onChange={handleInputChange}
              placeholder="e.g., A luxurious beachfront hotel with stunning ocean views and modern amenities."
