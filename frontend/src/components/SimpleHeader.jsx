      ...
      <div className="container mx-auto px-6 lg:px-12 py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <Link to="/services" className="text-[#203c8c] font-semibold text-lg hover:text-gray-500 transition-all duration-300">Services</Link>
          ...
          <div className={`${isMenuOpen ? "block" : "hidden"} lg:hidden absolute top-16 right-4 w-48 bg-white rounded-lg p-4 shadow-lg`}>
            ...
            <Link to="/services" className="block py-2 text-[#203c8c] font-medium hover:text-gray-500 transition-all duration-300" onClick={toggleMenu}>Services</Link>
