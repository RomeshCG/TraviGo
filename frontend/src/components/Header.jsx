        ...
        <nav className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center">
            <img
              src={logo}
              alt="TraviGo Logo"
              className="w-auto h-20 lg:h-14 transition-all duration-300 hover:scale-105"
            />
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <Link to="/services" className="text-[#203c8c] font-semibold text-lg hover:text-[#1a2f6e] transition-all duration-300">Services</Link>
          ...
          <div className={`${isMenuOpen ? "block" : "hidden"} lg:hidden absolute top-16 right-4 w-48 bg-white/90 backdrop-blur-md rounded-lg p-4 shadow-lg`}>
            ...
            <Link to="/services" className="block py-2 text-[#203c8c] font-medium hover:text-[#1a2f6e] transition-all duration-300" onClick={toggleMenu}>Services</Link>
            ...
            <div className="mt-4 flex flex-col space-y-2">
              ...
              <Link to="/register" className="bg-green-600 text-white px-4 py-2 rounded-full font-medium hover:bg-[#146b3a] transition-all duration-300" onClick={toggleMenu}>Register</Link>
            </div>
          </div>
        </nav>
      </div>
