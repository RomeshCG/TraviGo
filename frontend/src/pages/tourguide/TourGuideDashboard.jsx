...
const TourGuideDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (storedProvider) {
      ...
      if (providerData.providerType === 'TourGuide') {
        setProvider(providerData);
      } else {
        setError('Unauthorized access. Please log in as a Tour Guide.');
      }
    } else {
      ...
      {provider ? (
        <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md">
          ...
          <p className="text-gray-500 text-sm mt-4">
            This is a dummy dashboard for Tour Guides. The actual dashboard is under development.
          </p>
          <button
