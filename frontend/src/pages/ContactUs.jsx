...
import backgroundImage from "../assets/ContactusBackground.jpg"; // Adjust the path to your image
...
const ContactUs = () => {
  ...
  return (
    ...
    >
      <div className="max-w-5xl w-full flex flex-col md:flex-row gap-8 bg-white bg-opacity-90 p-6 rounded-lg">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-4">
            <p className="flex items-center text-gray-700">
              ...
              1055 Arthur ave Elk Groot, 67, New Palms South Carolina
            </p>
            <p className="flex items-center text-gray-700">
              <svg
                className="w-5 h-5 mr-2 text-blue-600"
