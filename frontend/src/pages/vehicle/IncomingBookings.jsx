...
const IncomingBookings = ({ providerId, setError }) => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        setError('Failed to fetch incoming bookings. Please try again.');
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-semibold mb-4">Incoming Bookings</h2>
      {bookings.length === 0 ? (
